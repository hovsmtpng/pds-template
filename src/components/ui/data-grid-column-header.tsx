...
import ColumnFilter from "@/components/ui/data-grid-column-header-custom-filter";
...
function DataGridColumnHeader<TData, TValue>({
  ...
  const headerControls = () => {
    return (
      ...
      <div className="flex">
        {
          props.tableLayout?.showColumnsPinnable &&
        ...
        {/* Jika ada filter custom gunakan itu, jika tidak gunakan ColumnFilter bawaan */}
        {filter ?? <ColumnFilter
          column={column}
          serverSideFilterValues={props?.tableLayout?.serverSideFilterValues}
          isServerSide={props?.tableLayout?.isServerSide}
          onChangeFilterColumns={props?.tableLayout?.onChangeFilterColumns}
        />}
      </div>
      </div>
    );
