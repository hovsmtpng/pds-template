  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        onPointerDownOutside={(e) => !closeOutsideClick && e.preventDefault()}
        onInteractOutside={(e) => !closeOutsideClick && e.preventDefault()}
        onEscapeKeyDown={(e) => !closeOutsideClick && e.preventDefault()}
